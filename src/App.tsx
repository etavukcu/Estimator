...
function OptionCards({ question, value, onChange }: { question: Question; value?: string; onChange: (value: string) => void }) {
  return (
    ...
    <Card>
      <div className="card-pad">
        ...
        <div className="top-lg">
          <OptionCards question={currentQuestion} value={answers[currentQuestion.id]} onChange={(value) => updateAnswer(currentQuestion.id, value)} />
        </div>
      </div>
    </Card>
  ) : null
    ...
    <div className="layout-two">
      <Card>
        <div className="card-pad">
          ...
          <div className="section-copy">This info is used only inside the PDF you download.</div>
      ...
      <Card className="text-white" style={{ background: `linear-gradient(135deg, ${BRAND.ink}, ${BRAND.forest})` }}>
        <div className="card-pad">
          ...
          <div className="info-box top-xl">This version keeps things simple: clients review the range and download the PDF themselves.</div>
        </div>
      </Card>
    </div>
  )
      ...
      <div className="container">
        ...
        {currentStage !== 'welcome' && currentStage !== 'results' ? (
          <div className="nav-row">
            ...
            {currentStage === 'lead' ? (
              <Button className="text-white" style={{ backgroundColor: BRAND.ink }} onClick={() => setStep(stages.length - 1)} disabled={!canContinue()}>
